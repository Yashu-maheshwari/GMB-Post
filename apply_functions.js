...
// Function 1: resolveVerifiedImageForBusiness
const start1 = code.indexOf('function resolveVerifiedImageForBusiness(businessKey, pillarId) {');
const end1 = code.indexOf('function executeScheduledPostForBusiness(businessKey) {');
const origResolve = code.substring(start1, end1);

const newResolve = `function resolveVerifiedImageForBusiness(businessKey, pillarId) {
...
// 2. generateGmbPostWithGemini
const start2 = code.indexOf('function generateGmbPostWithGemini(businessKey) {');
const end2 = code.indexOf('function getRecentImages(businessKey) {');
const origGen = code.substring(start2, end2);

const newGen = `function generateGmbPostWithGemini(businessKey) {
...
`;
code = code.replace(origGen, newGen);
